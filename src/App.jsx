      ...
      <section className="w-full px-8 text-gray-700 bg-white">
        <div className="container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
          ...
          <div className="inline-flex items-center ml-5 space-x-6 lg:justify-end">
            <Link
              to={"/home"}
              className="inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-black whitespace-no-wrap border border-transparent rounded-md shadow-sm hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600"
            >
              Đăng ký
            </Link>
            <Link
          ...
          <div className="flex flex-wrap items-center sm:-mx-3">
            <div className="w-full md:w-1/2 md:px-3">
              <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-3xl lg:text-5xl xl:text-5xl">
                  <span className="block xl:inline">TeleHeal - </span>
                  <span className="block text-indigo-600 xl:inline">
                    Chăm sóc sức khỏe của bạn, mọi lúc, mọi nơi
                  </span>
                </h1>
                <p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                  Telehealth là dịch vụ chăm sóc sức khỏe từ xa qua công nghệ,
                  cho phép tư vấn, chẩn đoán và điều trị mà không cần gặp trực
                  tiếp, giúp mở rộng khả năng tiếp cận y tế.
                </p>
